...
prototxt_path = "assets/deploy.prototxt"
caffemodel_path = "assets/res10_300x300_ssd_iter_140000_fp16.caffemodel"
...
def detect_face(image_path: str, required_face_coverage: float) -> StandardResponse:
    ...
    region_x_min, region_y_min = 0.20, 0.20  # top-left corner (20% from left and top)
    region_x_max, region_y_max = 0.80, 0.80  # bottom-right corner (80% from left and top)
