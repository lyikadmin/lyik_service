...
if __name__ == '__main__':
    ...
    for k, m in model.named_modules():
        ...
        if isinstance(m, signature_ml.SOURCE.yolo_files.models.common.Conv):  # assign export-friendly activations
            if isinstance(m.act, nn.Hardswish):
                m.act = Hardswish()
            elif isinstance(m.act, nn.SiLU):
                m.act = SiLU()
        elif isinstance(m, signature_ml.SOURCE.yolo_files.models.yolo.Detect):
